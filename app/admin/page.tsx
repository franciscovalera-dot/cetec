    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-0 mb-6">
          <div>
            <h2 className="text-2xl  text-gray-900">Entradas</h2>
        ...
        <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden">
          {loading ? (
            ...
            <div className="text-center py-20">
              ...
              <Link
                href="/admin/entradas/nueva"
                className="inline-flex items-center gap-1 mt-3 text-sm  text-gray-900 hover:text-gray-700"
              >
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-200 bg-gray-50">
                  ...
                  <th className="text-left text-xs  text-gray-900 uppercase tracking-wide px-4 py-3 hidden md:table-cell">Sección</th>
                  <th className="text-left text-xs  text-gray-900 uppercase tracking-wide px-4 py-3 hidden lg:table-cell">Temática</th>
                ...
                {(Array.isArray(posts) ? posts : []).map((post) => (
                  <tr key={post._id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-4 py-4 hidden md:table-cell">
                      <span className="inline-block text-xs  px-2.5 py-1 bg-gray-100 text-gray-700 rounded-full">
